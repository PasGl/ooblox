...
```
        ...
        location ~ /sandbox {
                rewrite ^ http://51.15.67.244/?cammod=OCM+30+-50+9+32+-50+-2&thisMenu=OMM+66+-57+-26+false&TPL1501595236567=TPL+12.5+-58+-30+30+15+6+0.5+0.1+-10+-10+0+ooblox-controls.png&ENV1501867801551=ENV+0+-55+0+1600+1600+315+36+-1.5+-30+35+35+41382439+7+dirt+CloudyLightRays;
        }
```
