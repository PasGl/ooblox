...
THREE.BBTubeGeometry = function( path, radii, segments, radialSegments, closed, verticalTextureScalar ) {
	...
	var frames = new THREE.BBTubeGeometry.FrenetFrames( this.path, this.segments, this.closed ),
	...
	for ( i = 0; i < this.segments; i++ )
	{
		...
		for ( j = 0; j < this.radialSegments; j++ )
		{
			...
			uvb = new THREE.Vector2( this.verticalTextureScalar * ((i + 1) 	/ this.segments ) / radius	, j / this.radialSegments );
			uvc = new THREE.Vector2( this.verticalTextureScalar * ((i + 1) 	/ this.segments ) / radius	, ( j + 1 ) / this.radialSegments );
...
THREE.BBTubeGeometry.prototype = Object.create( THREE.Geometry.prototype );

// For computing of Frenet frames, exposing the tangents, normals and binormals the spline
THREE.BBTubeGeometry.FrenetFrames = function(path, segments, closed)
{
