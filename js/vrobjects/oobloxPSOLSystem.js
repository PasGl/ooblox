...
function PSOLSystem ()
{
 	...
 	this.flower = function (turtle)
	{
		...
		closingGeometry.normalsNeedUpdate = true;
	...
	this.refreshFoliageTexture = function (targetScene,thismesh)
	{
		...
		thismesh.children[0].material.specularMap.anisotropy = 16;
	}
